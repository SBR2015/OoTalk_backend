...
RSpec.describe Api::V1::CoursesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all api_v1_courses as @api_v1_courses" do
      course = Course.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:api_v1_courses)).to eq([course])
    end
  end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the api_v1_courses list" do
      course = Course.create! valid_attributes
      delete :destroy, {:id => course.to_param}, valid_session
      expect(response).to redirect_to(api_v1_courses_url)
    end
  end
